...
/**
 * Contains artifacts for the Kakoo's Gaming (Atlas) Model component dedicated to the npc (non player character) entities.
 */
package com.kakoo.gaming.atlas.model.bestiary.character.npc;