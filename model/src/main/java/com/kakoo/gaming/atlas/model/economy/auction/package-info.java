...
/**
 * Contains artifacts for the Kakoo's Gaming (Atlas) Model component dedicated to the auction (house) entities.
 */
package com.kakoo.gaming.atlas.model.economy.auction;